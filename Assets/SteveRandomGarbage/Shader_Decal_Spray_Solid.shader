Shader "GAPH Custom Shader/Shader_Decal_Spray_Solid"{
		Properties{
		...
		Category{
			...
			ZTest[_ZTest1]
			ZWrite Off
			// No stencil restriction for sprays: render on any receiver
        Stencil
        {
            Comp Always
            Pass Keep
			...
			SubShader{
				Pass{
						...
						half4 frag(v2f i) : SV_Target
						{
							...
							// Force full alpha for solid sprays to prevent bleeding through
							tex.a = 1.0;
							...
							#endif
								// Force completely opaque output for solid sprays
								res.a = 1.0;
